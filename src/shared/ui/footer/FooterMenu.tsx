...
export default function FooterMenu({ lang }: Props) {
  return footer_menu.map((menu, index) => (
    <Group key={index} lang={lang} title={menu.title[lang]} links={menu.links} />
  ));
}
...
const Group = ({
  ...
  return (
    <div className="flex flex-col gap-1 border-t lg:border-t-0 w-full lg:w-auto p-4 lg:p-0 rtl:text-lg">
